  ...
  return (
    <section className="pt-8 sm:pt-12 md:pt-24 px-4 sm:px-6 md:px-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 auto-rows-auto gap-4 sm:gap-6 w-full">
            ...
            <div className="lg:col-span-2 lg:row-span-2 border-10 border-[var(--accent-hex)] rounded-4xl pt-6 sm:pt-8 md:pt-[59px] px-4 sm:px-6 md:px-[39px]">
            ...
            {/* UCV */}
            <div className="lg:col-span-3 lg:col-start-3 border-10 border-[var(--accent-hex)] rounded-4xl flex flex-row items-center self-center py-6 sm:py-8 md:py-24 pl-4 sm:pl-6">
            ...
            {/* UCLA */}
            <div className="lg:col-span-3 lg:col-start-3 lg:row-start-2 border-10 border-[var(--accent-hex)] rounded-4xl flex flex-row items-center self-center py-6 sm:py-8 md:py-24 pl-4 sm:pl-6">
            ...
            {/* AGREGA TU UNI */}
            <div className="lg:col-span-5 lg:row-start-3 border-10 border-[var(--accent-hex)] rounded-4xl px-4 sm:px-6 md:px-[32px]">
