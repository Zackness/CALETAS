  ...
  return (
    <section className="pt-8 sm:pt-12 md:pt-24 px-4 sm:px-6 md:px-20">
        ...
        <div className="flex flex-col md:flex-row md:justify-between md:items-end pt-6 sm:pt-[30px] pb-6 sm:pb-[30px] gap-4">
            <h2 className="chalk-title text-[1.75rem] sm:text-[2rem] md:text-[3rem] lg:text-[40px] font-special">
                UNIVERSIDADES
            </h2>
            <a 
                href=""
                className="text-sm sm:text-base md:text-[18px] font-bold pb-3 self-start md:self-end hover:text-[var(--accent-hex)] transition-colors"
            >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 auto-rows-auto gap-4 sm:gap-6 w-full">
            ...
            <div className="chalk-sketch-border lg:col-span-2 lg:row-span-2 rounded-4xl pt-6 sm:pt-8 md:pt-[59px] px-4 sm:px-6 md:px-[39px]">
            ...
            {/* UCV */}
            <div className="chalk-sketch-border lg:col-span-3 lg:col-start-3 rounded-4xl flex flex-row items-center self-center py-6 sm:py-8 md:py-24 pl-4 sm:pl-6">
            ...
            {/* UCLA */}
            <div className="chalk-sketch-border lg:col-span-3 lg:col-start-3 lg:row-start-2 rounded-4xl flex flex-row items-center self-center py-6 sm:py-8 md:py-24 pl-4 sm:pl-6">
            ...
            {/* AGREGA TU UNI */}
            <div className="chalk-sketch-border lg:col-span-5 lg:row-start-3 rounded-4xl px-4 sm:px-6 md:px-[32px]">
