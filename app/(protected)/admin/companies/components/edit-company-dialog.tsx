...
export const EditCompanyDialog = ({
  ...
  // Actualizar los valores del formulario cuando cambie la empresa
  useEffect(() => {
    if (company) {
      form.reset({
        ...
        RIF: company.RIF,
        persona_de_contacto: company.persona_de_contacto,
        email: company.email,
        tipo: company.tipo,
                  ...
                  <div className="flex gap-2">
                    <FormControl>
                      <Input
                        ...
                        {...field}
                        placeholder="Ingrese la nueva contraseña de la empresa"
                        disabled={isPending}
                      />
                    </FormControl>
                    <Button
