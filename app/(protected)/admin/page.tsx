...
import { Solicitud, User, Familiar, Documento, Detalle, Nota, UserRole } from "@prisma/client";
...
export default async function AdminPage() {
  ...
  // Redirigir a los usuarios con rol de cliente a la página home
  if (user?.role === UserRole.CLIENT) {
    return redirect("/home");
  }
  
  const { pendingSolicitudes, aprovedSolicitudes, inProgressSolicitudes, completedSolicitudes, regectedSolicitudes } = await getSolicitudWithCount();
